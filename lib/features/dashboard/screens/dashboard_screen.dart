...
import 'package:flutter_project/data/models/product_models.dart';
import 'package:flutter_project/core/app_strings.dart';
import 'package:flutter_project/ui/screens/product_list_screen.dart';
import 'package:flutter_project/ui/screens/login_screen.dart';
import 'package:flutter_project/ui/screens/scan_screen.dart';
import 'package:flutter_project/ui/screens/device_detail_screen.dart';
import 'dart:async';
import 'package:flutter_project/ui/widgets/product_thumbnail_widget.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    if (_isPagedHierarchyLevel) {
      ...
      _serialSub = CutterSerialService().serialStream.listen((serial) {
        if (!mounted) return;
  ...
  void _showBypassDialog() {
    ...
    final currentAgent = CutterSerialService().cachedAgentType;
    ...
    bool showTypeSelection = CutterSerialService().isBypassMode;
    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setAltState) => AlertDialog(
          ...
          actions: [
            if (CutterSerialService().isBypassMode)
              TextButton(
                onPressed: () {
                  CutterSerialService().setBypassMode(false);
            ...
            TextButton(
              onPressed: () {
                if (!showTypeSelection) {
                  ...
                  CutterSerialService().setBypassMode(
                    true,
                    agentType: agent,
  ...
  Widget build(BuildContext context) {
    final serialNumber = CutterSerialService().serialNumber;
    final isConnected = CutterSerialService().isConnected;
    final isBypassed = CutterSerialService().isBypassMode;
