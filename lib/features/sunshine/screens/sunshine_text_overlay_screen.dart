...
class SunshineTextOverlayScreenResult {
  const SunshineTextOverlayScreenResult({this.spec, this.cleared = false});

  final CutTextOverlaySpec? spec;
  final bool cleared;
}

Future<SunshineTextOverlayScreenResult?> showSunshineTextOverlayScreen(
  BuildContext context, {
  CutTextOverlaySpec? initialSpec,
}) {
  return showModalBottomSheet<SunshineTextOverlayScreenResult>(
    context: context,
    ...
    builder: (context) => _SunshineTextOverlayScreen(initialSpec: initialSpec),
  );
}

class _SunshineTextOverlayScreen extends StatefulWidget {
  const _SunshineTextOverlayScreen({this.initialSpec});

  final CutTextOverlaySpec? initialSpec;

  @override
  State<_SunshineTextOverlayScreen> createState() => _SunshineTextOverlayScreenState();
}

class _SunshineTextOverlayScreenState extends State<_SunshineTextOverlayScreen> {
  ...
  void _submit() {
    ...
    Navigator.of(context).pop(
      SunshineTextOverlayScreenResult(
                    ...
                    Expanded(
                      child: OutlinedButton(
                        onPressed: () {
                          Navigator.of(
                            context,
                          ).pop(const SunshineTextOverlayScreenResult(cleared: true));
                        },
