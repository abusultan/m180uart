                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(value: 'Righteous', child: Text('Righteous', style: TextStyle(fontFamily: 'Righteous'))),
                      DropdownMenuItem(value: 'Cinzel', child: Text('Cinzel', style: TextStyle(fontFamily: 'Cinzel'))),
                    ],
                    onChanged: (val) {
                      if (val != null) {
